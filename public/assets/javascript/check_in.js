var checkinApp = new Vue({
    ...
    methods: {
        fetchAttendees: function () {
            this.$http.post(maxticket.checkInSearchRoute, {q: this.searchTerm}).then(function (res) {
        ...
        toggleCheckin: function (attendee) {
            ...
            this.$http.post(maxticket.checkInRoute, checkinData).then(function (res) {
        ...
        QrCheckin: function (attendeeReferenceCode) {
            ...
            this.$http.post(maxticket.qrcodeCheckInRoute, {attendee_reference: attendeeReferenceCode}).then(function (res) {
