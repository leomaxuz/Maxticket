...
trait OrganisationWithoutTax
{
    ...
    public function setupOrganisationWithoutTax()
    {
        $orderStatuses = collect([
            ['id' => config('maxticket.order.complete'), 'name' => 'Completed'],
            ['id' => config('maxticket.order.refunded'), 'name' => 'Refunded'],
            ['id' => config('maxticket.order.partially_refunded'), 'name' => 'Partially Refunded'],
            ['id' => config('maxticket.order.cancelled'), 'name' => 'Cancelled'],
        ]);
