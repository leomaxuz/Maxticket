...
return array (
  ...
  'licence_info_description' => 'maxticket is licenced under the <b><a target="_blank" href="https://tldrlegal.com/license/attribution-assurance-license-(aal)#summary">Attribution Assurance Licence (AAL)</a></b>. This licence requires the <b>\'Powered By maxticket\'</b> notice to be kept in place on any maxticket installation. If you wish to remove references to maxticket you must purchase one of the white-label licences <b><a target="_blank" href="https://xbayt.uz/license.html">listed here</a></b>.',
  ...
  'open_source_soft_description' => 'maxticket is built using many fantastic open-source libraries. You can see an overview of these on <b><a href="https://libraries.io/github/maxticket/maxticket?ref=maxticket_About_Page" target="_blank">libraries.io</a></b>.',
  'payment' => 'Payment',
  ...
  'version_out_of_date' => 'Your version (<b>:installed</b>) of maxticket is out of date. The latest version (<b>:latest</b>) can be <a href=":url" target="_blank">downloaded here</a>',
  'version_up_to_date' => 'Your maxticket version (<b>:installed</b>) is up to date!',
