                            ...
                            <div class="tab-pane " id="about">
                                ...
                                <p>
                                    @if(is_array($version_info) && $version_info['is_outdated'])
                                        @lang("ManageAccount.version_out_of_date", ["installed" => $version_info['installed'], "latest"=> $version_info['latest'], "url"=>"https://xbayt.uz/documentation.php#download"]).
                                    @elseif(is_array($version_info))
                                        @lang("ManageAccount.version_up_to_date", ["installed" => $version_info['installed']])
                                    @else
                                        Error retrieving the latest maxticket version.
                                    @endif
                                </p>
                                <h4>
