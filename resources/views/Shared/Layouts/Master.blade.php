...
<head>
   ...
   <!--/Meta-->
    ...
    <!--JS-->
    {!! Html::script(config('maxticket.cdn_url_static_assets').'/vendor/jquery/dist/jquery.min.js') !!}
    <!--/JS-->

    <!--Style-->
    {!! Html::style(config('maxticket.cdn_url_static_assets').'/assets/stylesheet/application.css') !!}
    <!--/Style-->

    <!--rtl-style-->
    @if (config('app.locale_dir') =='rtl')
        {!! Html::style(config('maxticket.cdn_url_static_assets').'/assets/stylesheet/application-rtl.css') !!}    
    @endif
    <!--/rtl-style-->

    @yield('head')
</head>
<body class="maxticket">
@yield('pre_header')
<header id="header" class="navbar">

    <div class="navbar-header">
        <a class="navbar-brand" href="javascript:void(0);">
            <img style="width: 150px;" class="logo" alt="maxticket" src="{{asset('assets/images/logo-light.png')}}"/>
        </a>
    </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown profile">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a target="_blank" href="https://github.com/maxticket/maxticket/issues/new?body=Version%20{{ config('maxticket.version') }}"><span class="icon ico-megaphone"></span>@lang("Top.feedback_bug_report")</a></li>
                    <li class="divider"></li>
