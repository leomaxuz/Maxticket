...
@section('head')
    {!! Html::script('https://maps.googleapis.com/maps/api/js?libraries=places&key='.config("maxticket.google_maps_geocoding_key")) !!}
                            ...
                            <table class="table">
                                ...
                                @foreach($event->affiliates as $affiliate)
                                    <tr>
                                        ...
                                        <td>{{ $affiliate->updated_at->format(config("maxticket.default_datetime_format")) }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                                ...
                                <div class="panel panel-default" data-type="image">
                                    ...
                                    <div id="bgImage"
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <a class="btn btn-link" href="https://pixabay.com?ref=maxticket" title="PixaBay Free Images">
