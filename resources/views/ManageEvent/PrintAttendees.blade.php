<html>
    ...
    <body style="background-color: #FFFFFF;" onload="window.print();">
        <div class="well" style="border:none; margin: 0;">
            {{ @trans("Event.n_attendees_for_event", ["num"=>$attendees->count(), "name"=>$event->title, "date"=>$event->start_date->format(config('maxticket.default_datetime_format'))]) }}
            <br>
        </div>
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$attendee->created_at->format(config("maxticket.default_datetime_format"))}}</td>
