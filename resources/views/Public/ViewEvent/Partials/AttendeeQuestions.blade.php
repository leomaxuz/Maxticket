@foreach($ticket->questions->where('is_enabled', 1)->sortBy('sort_order') as $question)
    <div class="col-md-12">
        <div class="form-group">
            ...
            @if($question->question_type_id == config('maxticket.question_textbox_single'))
            ...
            @elseif($question->question_type_id == config('maxticket.question_textbox_multi'))
            ...
            @elseif($question->question_type_id == config('maxticket.question_dropdown_single'))
            ...
            @elseif($question->question_type_id == config('maxticket.question_dropdown_multi'))
            ...
            @elseif($question->question_type_id == config('maxticket.question_checkbox_multi'))
                <br>
                ...
                @endforeach
            @elseif($question->question_type_id == config('maxticket.question_radio_single'))
                <br>
                @foreach($question->options as $option)
                    <?php
