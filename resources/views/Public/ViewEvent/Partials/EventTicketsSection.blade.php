                                ...
                                <span class="ticket-title semibold" property="name">
                                    ...
                                    @lang("Public_ViewEvent.currently_not_on_sale")
                                            ...
                                            @else
                                                ...
                                                @if($ticket->sale_status === config('maxticket.ticket_status_sold_out'))
                                                    <span class="text-danger" property="availability"
                                                          content="http://schema.org/SoldOut">
                                    @lang("Public_ViewEvent.sold_out")
                                </span>
                                                @elseif($ticket->sale_status === config('maxticket.ticket_status_before_sale_date'))
                                                    <span class="text-danger">
                                    @lang("Public_ViewEvent.sales_have_not_started")
                                </span>
                                                @elseif($ticket->sale_status === config('maxticket.ticket_status_after_sale_date'))
                                                    <span class="text-danger">
