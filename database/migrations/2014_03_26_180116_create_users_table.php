...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('accounts', function ($t) {
            ...
            //$t->unsignedInteger('payment_gateway_id')->default(config('maxticket.default_payment_gateway'));
        ...
        Schema::create('events', function ($t) {
            ...
            $t->string('bg_color')->default(config('maxticket.event_default_bg_color'));
