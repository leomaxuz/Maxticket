...
$factory->define(App\Models\Event::class, function (Faker\Generator $faker) {
    return [
        ...
        'location' => $faker->text,
        'bg_type' => 'color',
        'bg_color' => config('maxticket.event_default_bg_color'),
        'bg_image_path' => $faker->imageUrl,
        'description' => $faker->text,
        'start_date' => Carbon::now()->format(config('maxticket.default_datetime_format')),
        'end_date' => Carbon::now()->addWeek()->format(config('maxticket.default_datetime_format')),
        'on_sale_date' => Carbon::now()->subDays(20)->format(config('maxticket.default_datetime_format')),
        'account_id' => function () {
