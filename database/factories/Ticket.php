...
$factory->define(App\Models\Ticket::class, function (Faker\Generator $faker) {
    return [
        ...
        'quantity_sold' => 0,
        'start_sale_date' => Carbon::now()->format(config('maxticket.default_datetime_format')),
        'end_sale_date' => Carbon::now()->addDays(20)->format(config('maxticket.default_datetime_format')),
        'sales_volume' => 0,
