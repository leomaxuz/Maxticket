...
class EventController extends MyBaseController
{
    ...
    public function postCreateEvent(Request $request)
    {
         ...
         */
        $event->bg_type = 'image';
        $event->bg_image_path = config('maxticket.event_default_bg_image');
        ...
        if ($request->hasFile('event_image')) {
            ...
            $eventImage->image_path = config('maxticket.event_images_path') . '/' . $filename;
    ...
    public function postUploadEventImage(Request $request)
    {
        if ($request->hasFile('event_image')) {
            ...
            $relative_path_to_file = config('maxticket.event_images_path') . '/' . $file_name;
