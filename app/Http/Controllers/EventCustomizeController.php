...
class EventCustomizeController extends MyBaseController
{
    ...
    public function getAvailableBackgroundImages()
    {
        ...
        $files = File::files(public_path() . '/' . config('maxticket.event_bg_images'));
    ...
    public function getAvailableBackgroundImagesThumbs()
    {
        ...
        $files = File::files(public_path() . '/' . config('maxticket.event_bg_images') . '/thumbs');
    ...
    public function postEditEventDesign(Request $request, $event_id)
    {
        ...
        if ($request->hasFile('bg_image_path') && $request->get('bg_type') == 'custom_image') {
            $path = public_path() . '/' . config('maxticket.event_images_path');
            ...
            $event->bg_image_path = config('maxticket.event_images_path') . '/' . $filename;
            $event->bg_type = 'custom_image';

            \Storage::put(config('maxticket.event_images_path') . '/' . $filename, file_get_contents($file_full_path));
        }
