...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'maxticket:install';
     ...
     * @var string
     */
    protected $description = 'Install maxticket';
    ...
    public function handle()
    {
        ...
        $this->comment('--------------------');
        $this->comment('Attempting to install maxticket v' . $version);
        $this->comment('--------------------');
 ...
 /_/    \_\__|\__\___|_| |_|\__,_|_/___\___|
        ...
        $this->comment('Success! You can now run maxticket');
    }
}
