...
class Utils
{
    ...
    /**
     * Are we the cloud version of maxticket or in dev enviornment?
     *
     * @return bool
     */
    public static function ismaxticket()
    {
        return self::ismaxticketCloud() || self::ismaxticketDev();
    }

    /**
     * Are we the cloud version of maxticket?
     *
     * @return bool
     */
    public static function ismaxticketCloud()
    {
        return isset($_ENV['maxticket_CLOUD']) && $_ENV['maxticket_CLOUD'] == 'true';
    }
     ...
     * @return bool
     */
    public static function ismaxticketDev()
    {
        return isset($_ENV['maxticket_DEV']) && $_ENV['maxticket_DEV'] == 'true';
    }
    ...
    /**
     * Check if maxticket is installed
     *
     * @return bool
     */
