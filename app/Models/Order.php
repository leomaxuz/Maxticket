...
class Order extends MyBaseModel
{
    ...
    public function generatePdfTickets()
    {
        ...
        $pdf_file_path = public_path(config('maxticket.event_pdf_tickets_path')) . '/' . $this->order_reference;
        ...
        $this->ticket_pdf_path = config('maxticket.event_pdf_tickets_path') . '/' . $this->order_reference . '.pdf';
        $this->save();
