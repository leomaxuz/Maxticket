...
class Event extends MyBaseModel
{
    ...
    {
        return config('maxticket.ticket_booking_fee_fixed') + $this->organiser_fee_fixed;
    }
    ...
    {
        return config('maxticket.ticket_booking_fee_percentage') + $this->organiser_fee_percentage;
    }
    ...
    {
        return $this->start_date->format(config('maxticket.default_datetime_format'));
    }
    ...
    {
        return $this->end_date->format(config('maxticket.default_datetime_format'));
    }
    ...
    {
        return "<!--xbayt.uz Ticketing Embed Code-->
